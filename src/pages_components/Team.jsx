  ...
  return (
    ...
    <div className="team-component">
      <div className="team-member">
        ...
        <p className="team-member__description">Sébastien</p>
      </div>
      <div className="team-member">
        ...
        <p className="team-member__description">Mara</p>
      </div>
      <div className="team-member">
        ...
        <p className="team-member__description">Julien</p>
      </div>
      <div className="team-member">
        ...
        <p className="team-member__description">Jeremy</p>
      </div>
      <div className="team-member">
